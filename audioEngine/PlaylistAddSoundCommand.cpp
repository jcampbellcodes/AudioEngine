...
// preferable -- hash early
PlaylistAddSoundCommand::PlaylistAddSoundCommand(unsigned int sndID, const char* pathname) : soundID(sndID), playlist(nullptr)
{
	SoundManager::LoadSound(sndID, pathname);
}
